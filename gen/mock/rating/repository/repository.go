...
// MockratingIngestor is a mock of ratingIngestor interface.
type MockratingIngestor struct {
        ctrl     *gomock.Controller
        recorder *MockratingIngestorMockRecorder
}

// MockratingIngestorMockRecorder is the mock recorder for MockratingIngestor.
type MockratingIngestorMockRecorder struct {
        mock *MockratingIngestor
}

// NewMockratingIngestor creates a new mock instance.
func NewMockratingIngestor(ctrl *gomock.Controller) *MockratingIngestor {
        mock := &MockratingIngestor{ctrl: ctrl}
        mock.recorder = &MockratingIngestorMockRecorder{mock}
        return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockratingIngestor) EXPECT() *MockratingIngestorMockRecorder {
        return m.recorder
}

// Ingest mocks base method.
func (m *MockratingIngestor) Ingest(ctx context.Context) (chan model.RatingEvent, error) {
        m.ctrl.T.Helper()
...
func (mr *MockratingIngestorMockRecorder) Ingest(ctx interface{}) *gomock.Call {
        mr.mock.ctrl.T.Helper()
        return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Ingest", reflect.TypeOf((*MockratingIngestor)(nil).Ingest), ctx)
}