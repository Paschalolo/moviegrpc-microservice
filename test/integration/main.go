...
import (
	...
	registryy "movieexample.com/pkg/discovery/memory"
...
func startMetadataService(ctx context.Context, registry discovery.Registery) *grpc.Server {
...
func startRatingService(ctx context.Context, registry discovery.Registery) *grpc.Server {
...
func startMovieService(ctx context.Context, registry discovery.Registery) *grpc.Server {
